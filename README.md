...
| Relevance-model comparison | June 15, 2026, approximately 03:49–09:12 China Standard Time (UTC+8) | Six model/reasoning configurations were evaluated on the 1,000-message validation set. |
| Full-corpus relevance screening | June 15, 2026, approximately 11:49–17:09 China Standard Time (UTC+8) | Qwen3.6 Flash no-thinking was used to screen the 325,665-message candidate corpus, including subsequent repair passes for failed or invalid batches. |
